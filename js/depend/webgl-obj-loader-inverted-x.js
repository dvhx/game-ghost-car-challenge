(function (scope, undefined) {
  ...
  OBJ.Mesh = function (objectData) {
     ...
     */
    var verts = [], vertNormals = [], textures = [], unpacked = {}, materials = {};
    // unpacking stuff
    unpacked.verts = [];
    unpacked.norms = [];
    unpacked.textures = [];
    ...
    for (var i = 0; i < lines.length; i++) {
      ...
      if (VERTEX_RE.test(line)) {
        ...
        //elements = [0,0,1]; // it seems to be ignored
        ...
        */
        ...
        for (var j = 0, eleLen = elements.length; j < eleLen; j++){
            ...
            if(elements[j] in unpacked.hashindices){
                ...
                // vertex normals
                //console.error(vertNormals[(vertex[2] - 1) * 3 + 0]);
